...
object DTLValidator {
    ...
    private fun getFieldsFromDTL(x: Specification.ToObject): Set<String> = x.entries.map { it.key }.toSet()
     ...
     */
    fun compareDTLWithJSONSchema(schema: String, obj: Specification.ToObject): Boolean =
